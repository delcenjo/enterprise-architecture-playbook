...
class CalculationEngine:
    ...
    def run_layer_3(self):
        """
        Deterministic financial orchestrator: loads multi-region context,
        models workload with environmental factors, runs multi-provider pricing
        with currency conversion, and produces comparison and simulation outputs.
        """
